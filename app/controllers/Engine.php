...
class Engine
{
  ...
  private static function checkIn()
  {
    ...
    if (file_exists('./vendor/autoload.php')) {
      ...
      echo 'Necessário a instalação das dependências do composer. Execute o comando na raiz do projeto: $ composer init';
      exit;
    }
  ...
  private static function endPointProcess()
  {
    ...
    self::$endPointParams = self::$endpointClass->start();
