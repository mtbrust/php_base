...
class NoticiasControllerPage extends ControllerPage
{
  ...
  public function pre()
  {
    ...
    $this->paramsTemplate = array(
      ...
      // 'corpo'    => 'coopama',   // Reservado para arquivo html.
  ...
  public function index()
  {
    ...
    // $this->paramsPage['usuarios'] = BdUsuarios::getAll();
      ...
      $html = ControllerRender::renderObj('lista', $params);
      $this->paramsTemplateObjs['p_lista'] = $html;
      //$this->paramsPage['noticias'] = BdNoticias::selecionaTudo();
    return true;
  }
