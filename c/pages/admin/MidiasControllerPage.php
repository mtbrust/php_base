 ...
 */
class MidiasControllerPage extends ControllerPage
{
  ...
  public function pre()
  {
    ...
    $this->paramsView = array(
      'title'            => 'Mídias',            // Título da página exibido na aba/janela navegador.
  ...
  public function get()
  {
    ...
    $params['dados'] = BdMidia::selecionaTudo();
    // Monta as colunas.
  ...
  public function api()
  {
    ...
    $midia = BdMidia::selecionaPorId($parametro);
    //print_r($midia);
    $r = $midia;

    $r = ControllerRender::renderObj('midias/item', array_merge($r, ['URL_RAIZ' => URL_RAIZ]));
