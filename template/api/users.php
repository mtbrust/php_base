 ...
 * 
 */
class users extends \controllers\EndPoint
{
  ...
  public function loadParams()
  {
    ...
    self::$params['render']      = [
      ...
      // 'content_type' => 'application/pdf',   // * Tipo do retorno padrão do cabeçalho http.
  ...
  {
    // testes
    // $pdf = \classes\PDF::base64('<div>teste</div>');

    // self::$params['render']['content_type'] = 'application/pdf';

    self::$params['response'] = ['resposta'];
  }
