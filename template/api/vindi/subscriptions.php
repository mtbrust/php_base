 ...
 * 
 */
class subscriptions extends \controllers\EndPoint
{
  ...
  public function get($params)
  {
    ...
    self::$params['response'] = \classes\ApiVindi::getSubscriptionsById($response['$_GET']['id']);
  }
   ...
   * @param  mixed $params
   */
  public function byCustomer($params)
  {
    $response['method'] = __FUNCTION__;
    $response[__FUNCTION__] = $params[strtolower(__FUNCTION__)];
    $response['$_GET'] = $_GET;

    self::$params['response'] = \classes\ApiVindi::getSubscriptionsByCustomer($response['$_GET']['customer_id']);
  }
  ...
  public function post($params)
  {
    ...
    self::$params['response'] = \classes\ApiVindi::postSubscriptions($response['$_POST']);
  }
  ...
  public function put($params)
  {
    ...
    // Finaliza a execução da função.
    self::$params['response'] = \classes\ApiVindi::putSubscriptions($params['infoUrl']['attr'][0], $response['$_POST']);
  }
  ...
  public function delete($params)
  {
    ...
    // Finaliza a execução da função.
    self::$params['response'] = \classes\ApiVindi::deleteSubscriptions($params['infoUrl']['attr'][0]);
  }
}
