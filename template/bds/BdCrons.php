...
class BdCrons extends \controllers\DataBase
{
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            "endpoint"    => "varchar(255) COLLATE latin1_general_ci DEFAULT NULL COMMENT 'campo referente a URL.'",
    ...
    public function selectJobByBillId($BillId)
    {
        // Ajusta nome real da tabela.
        $table = parent::fullTableName('crons');
        ...
        // Monta SQL.'
        $sql = "SELECT * FROM $table WHERE externalId = ". $BillId .";";
