...
class BdVindiCronsErrors extends \controllers\DataBase
{
     ...
     * @var string
     */
    protected $tableName = 'vindiCronsErrors';
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            "logError"    => "longtext COLLATE latin1_general_ci DEFAULT NULL COMMENT 'campo referente ao log de erro.'",
        ];
