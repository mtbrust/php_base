...
class BdLogsVindi extends \controllers\DataBase
{
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            "code"          => "varchar(50) COLLATE latin1_general_ci DEFAULT NULL COMMENT 'campo referente ao identificador da fatura na vindi.'",
            ...
            "url"           => "longtext COLLATE latin1_general_ci COMMENT 'campo referente a URL.'",
            "method"        => "varchar(100) COLLATE latin1_general_ci DEFAULT NULL COMMENT 'campo referente ao método da requisição.'",
            "request"       => "longtext COLLATE latin1_general_ci COMMENT 'campo referente ao JSON de requisição.'",
            "response"      => "longtext COLLATE latin1_general_ci COMMENT 'campo refernte ao JSON de resposta.'",
