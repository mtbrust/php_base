...
class BdLogsLyceum extends \controllers\DataBase
{
     ...
     * @var string
     */
    protected $tableName = 'logsLyceum';
    ...
    public function createTable($fields = null)
    {
        ...
        $fields = [
            ...
            "sourceIP"  => "int(11) DEFAULT NULL COMMENT 'campo referente ao IP de origem do usuário.'",
            "idStatus"  => "int(11) DEFAULT NULL COMMENT 'campo referente ao identificador de status do log.'",
            "dtCreate"  => "datetime DEFAULT NULL COMMENT 'campo referente a data de criação do log.'",
            "order"     => "int(11) DEFAULT NULL COMMENT 'campo referente ao pedido.'",
            "orderType" => "int(11) DEFAULT NULL COMMENT 'campo referente ao tipo de pedido. Ex: \"Loja\", \"Site\".'",
